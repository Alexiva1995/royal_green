 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow bg-purple-alt" data-scroll-to-active="true">
     ...
     <div class="main-menu-content">
         <ul class="navigation navigation-main bg-purple-alt mt-4" id="main-menu-navigation"
                 ...
                 <ul class="menu-content bg-purple-alt">
                     ...
                     <li class="activ">
                         <a href="{{$submenu['ruta']}}{{$submenu['complementoruta']}}" class="text-white"
                             ...
                             <span class="menu-item text-white"
                                 data-i18n="{{$submenu['name']}}">{{$submenu['name']}}</span></a>
                     </li>
                     @endforeach
                 </ul>
             </li>
