    ...
    <div class="card-content">
        <div class="card-body text-center" style="background:#ffffff !important">
            ...
            <div class="d-flex justify-content-center">
                    <div>
                        <h6>
                            Fecha Ingreso: <strong>{{date('d-m-Y', strtotime($data['fechaingreso']))}}</strong>
                        </h6>
                        <h6>
                            Patrocinador: <strong>{{$data['auspiciador']}}</strong>
                        </h6>
                        <h6>
                            Pto. Izq: <strong>{{$data['izquierda']}}</strong>
                        </h6>
                        <h6>
                            Pto. Dzq: <strong>{{$data['derecha']}}</strong>
                        </h6>
                    </div>
            </div>
        </div>
