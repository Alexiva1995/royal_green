        ...
        <div class="card-body">
			<div class="row">
				<div class="col-12 col-sm-6 col-md-10">
					...
					<input class="form-control form-control-solid placeholder-no-fix" id="iduser" type="number" autocomplete="off"
...
<script>
	function nuevoreferido(id, type) {
		let ruta = "{{url('/referraltree')}}/" + type + '/' + id
