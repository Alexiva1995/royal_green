<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <div class=" img-circle text-center">
            <img src="https://royalgreen.company/office/avatar/avatar.png" class="rounded-circle" alt=" ..."
            ...
            <div class="col-12 text-center">
                <div class="row">
                    <div class="col-6 text center">
                        <a class="btn btn-primary btn-inline" href="{{route('wallet')}}">
                            Retirar
                        </a>
                    </div>
                    <div class="col-6 text center">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="nav-item">
                        <a href="{{route('removerbilletera.index')}}">
                            <span class="menu-title" data-i18n="Historial de Ordenes">
                                Remover Billetera
                            </span>
                        </a>
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li class="nav-item">
                        <a href="{{route('price-confirmar', 'Real')}}">
                            <span class="menu-title" data-i18n="Historial de Ordenes">
                                Confirmar - Real
                            </span>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="{{route('price-confirmar', 'Patrocinado')}}">
                            <span class="menu-title" data-i18n="Historial de Ordenes">
                                Confirmar - Patrocinado
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
