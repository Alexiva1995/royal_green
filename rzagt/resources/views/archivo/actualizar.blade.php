    ...
    @endif
             ...
             <div class="col-sm-12">
               ...
               <label class="control-label " style="text-align: center; margin-top:4px;">Title</label>
                <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" name="titulo" value="{{$contenido->titulo}}" required style="background-color:f7f7f7;"/>
            ...
            <div class="col-sm-12">
               ...
               <label class="control-label " style="text-align: center; margin-top:4px;">Content</label>
                <textarea class="form-control form-control-solid placeholder-no-fix" type="textarea" autocomplete="off" name="contenido"><?php echo $contenido->contenido ?> 
                </textarea>
