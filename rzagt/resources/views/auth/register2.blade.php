                    ...
                    <div class="card rounded-0 mb-0 p-2 text-center" style="background: transparent;">
                        ...
                        <div class="card-content">
                            <div class="card-body pt-0">
                                ...
                                <form method="POST" class="" action="{{ route('autenticacion.save-register') }}">
                                    {{ csrf_field() }}
            ...
            <select name="referred_id" style="background-color:f7f7f7;"
                ...
                <option value="{{$user->ID}}">{{$user->display_name}}</option>
                            ...
                            <div class="form-group row text-center">
                                ...
                                <a href="{{asset('assets/Terminos_y_Condiciones_Aviso_de_privacidad_Aviso_legal_y_descargo_de_responsabilidad.pdf')}}" download>
