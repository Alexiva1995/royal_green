    ...
    <div class="card-content">
        <div class="card-body">
            <form method="post" action="{{ route('subir') }}">
                ...
                <div class="form-group">
                    <button class="btn btn-success" type="submit" id="btn">Enviar</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="card">
    ...
    <div class="card-content">
        <div class="card-body">
            <div class="media">
                <img src="https://royalgreen.company/office/avatar/avatar.png" class="mr-1" alt="img placeholder" height="64" width="64">
                ...
                <div class="media-body">
                    ...
                    <div class="media mt-3">
                        <a class="mr-1" href="#">
                            <img src="https://royalgreen.company/office/avatar/avatar.png" alt="Generic placeholder image" height="64"
                                width="64" />
                            {{-- <img src="{{asset('assets/img/'.$picture)}}" alt="Generic placeholder image" height="64"
                                width="64" /> --}}
                        </a>
                        <div class="media-body">
