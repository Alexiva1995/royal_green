  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('rentabilidad.retirar')}}" method="post">
          {{csrf_field()}}
          <div class="row" style="background:white;">
            ...
            <div class="form-group col-12 col-sm-6">
              ...
              <input class="form-control" type="text" name="montodisponible" readonly id="montodisponible"/>
            </div>
            <div class="form-group col-12 col-sm-6">
              ...
              <input id="idrentabilidad" name="idrentabilidad" class="form-control" type="hidden"/>
