...
class SettingController extends Controller
{
	...
	public function saveLogo(Request $datos){
	    if(!empty($datos->file('logo'))){
            ...
            if($movido){
                return redirect('office/admin/settings/sistema')->with('msj', 'Logo Updated Successfully');
            }
	    }else{
	        return redirect('office/admin/settings/sistema');
	    }
	}
	...
	public function savefavicon(Request $datos){
	    if(!empty($datos->file('favicon'))){
            ...
            if($movido){
                return redirect('office/admin/settings/sistema')->with('msj', 'Favicon Updated Successfully');
            }
	    }else{
	        return redirect('office/admin/settings/sistema');
	    }
	...
	public function updateName(Request $datos){
	    if(!empty($datos)){
	        ...
	        return redirect('office/admin/settings/sistema')->with('msj', 'System Name and Minimum Age Successfully Updated');
	    }else{
	        return redirect('office/admin/settings/sistema');
	    }
	}
	...
	public function saveForm(Request $datos){
	   if(!empty($datos)){
    	   ...
    	   if($valide){
			   ...
			   return redirect('office/admin/settings/formulario')->with('msj', 'The field '.$formulario->nameinput.' was successfully added');
    	   }
	   }else{
	       return redirect('office/admin/settings/formulario');
	   }
	}
	/**
	...
	public function statusField($id, $estado){
	    if (!empty($id)){
			...
			return redirect('office/admin/settings/formulario')->with('msj', 'The Field '.$formulario->nameinput.' Was Updated Successfully');
	    }else{
	       return redirect('office/admin/settings/formulario');
	   }
	}
	...
	public function updateForm(Request $datos)
	{
		if(!empty($datos)){
			...
			if($valide){
				...
				return redirect('office/admin/settings/formulario')->with('msj', 'The Field '.$datos->label.' Was Updated Successfully');
			}
		}
	}
	...
	public function terminos(Request $datos){
	    if(!empty($datos->file('terminos'))){
            ...
            if($movido){
                return redirect('office/admin/settings/formulario')->with('msj', 'New Terms and Conditions');
            }
	    }else{
	        return redirect('office/admin/settings/formulario');
	    }
	...
	public function saveSettingComision(Request $datos){
	    if(!empty($datos)){
	        ...
	        return redirect('office/admin/settings/comisiones')->with('msj', 'New Commission Process');
	    }else{
	        return redirect('office/admin/settings/comisiones');
	    }
	}
	...
	public function saveBono(Request $datos)
	{
		...
		return redirect('office/admin/settings/comisiones')->with('msj', 'Activation Bonus Updated');
	}
	...
	public function savePrimera_compra(Request $datos)
	{
		...
		return redirect('office/admin/settings/comisiones')->with('msj', 'Commission on First Purchase Updated');
	}
	...
	public function saveProducto(Request $datos)
	{
		...
		if ($validate) {
			...
			$settings->save();
			return redirect('office/admin/settings/comisiones')->with('msj', 'Product Id '.$datos->idproducto.' successfully added');
		}
	}
	...
	public function deleteProducto(Request $datos)
	{
		...
		$settings->id_no_comision = $tmp;
		$settings->save();
		return redirect('office/admin/settings/comisiones')->with('msj', 'Product Id '.$datos->idproducto_elimanar.' successfully removed');
	}
	...
	public function saveEstructura(Request $datos){
	    if(!empty($datos)){
	        ...
	        $this->resetSystem();
	        return redirect('office/admin/settings/estructura')->with('msj', 'New Structure Defined');
	    }
	}
	 ...
	 */
	 public function resetSystem(){
		...
		return redirect('office/admin')->with('msj', 'System Restarted');
	}
	...
	public function saveRangos(Request $datos)
	{
		if (!empty($datos)) {
			...
			return redirect('office/admin/settings/rangos')->with('msj', 'New Defined Range System');
		} else {
			return redirect('office/admin/settings/rangos');
		}
	}
	...
	public function savePagos(Request $datos)
	{
		...
		if(!empty($datos)){
			...
			return redirect('office/admin/settings/pagos')->with('msj', 'New Aggregate Payment Method');
		}else{
			return redirect('office/admin/settings/pagos');
		}
	}
	...
	public function comisionMetodoPago(Request $datos)
	{
	    if(!empty($datos)){
	        ...
	        $comisionMP->save();
	        return redirect('office/admin/settings/pagos')->with('msj', 'Updated Commissions');
	    }else{
	        return redirect('office/admin/settings/pagos');
	    }
	}
	...
	public function statusPago($id, $estado){
	    if (!empty($id)){
			...
			return redirect('office/admin/settings/pagos')->with('msj', 'The '.$metodopago->nameinput.' Payment Method was Updated Successfully');
	    }else{
	       return redirect('office/admin/settings/pagos');
	   }
	}
	...
	public function updateMetodo(Request $datos)
	{
		...
		if (!empty($datos)) {
			...
			return redirect('office/admin/settings/pagos')->with('msj', 'Updated Payment Method');
		}else{
			return redirect('office/admin/settings/pagos');
		}
	}
	...
	public function savePlantilla(Request $datos)
	{
		if (!empty($datos)) {
			...
			return redirect('office/admin/settings/plantilla')->with('msj', $datos->plantilla.' Mail Template has been updated');
		} else {
			return redirect('office/admin/settings/plantilla');
		}
	}
	...
	public function probarPlantilla(Request $datos)
	{
		...
		if (!empty($plantilla->contenido)) {
			...
			return redirect('office/admin/settings/plantilla')->with('msj', 'Test performed');
		} else {
			return redirect('office/admin/settings/plantilla');
		}
	}
	...
	public function saveAdmin(Request $datos)
	{
		...
		if ($validatedData) {
			...
			return redirect('office/admin/settings/permisos')->with('msj', 'New Administrator');
		} else {
			# code...
		}	
	}
	...
	public function savePermisos(Request $datos)
	{
		if (!empty($datos)) {
			if (!(empty($datos->id))) {
				...
				return redirect('office/admin/settings/permisos')->with('msj', 'Updated '.$datos->nameuser.' User Permissions');
		} else {
			return redirect('office/admin/settings/permisos');
		}
	...
	public function saveActivacion(Request $datos)
	{
		if (!empty($datos)) {
			...
			return redirect('office/admin/settings/activacion')->with('msj', 'Activation Method Updated');
		}else{
			return redirect('office/admin/settings/activacion');
		}
	}
	...
	public function saveMonedas(Request $datos)
	{
		...
		if ($validate) {
			...
			return redirect('office/admin/settings/monedas')->with('msj', $datos->nombre.' Currency Successfully Added');
		}
	}
	...
	public function statusMoneda($id, $estado)
	{
		...
		return redirect('office/admin/settings/monedas')->with('msj', $moneda->nombre.' Currency Successfully Updated');
	}
	...
	public function deleteMoneda($id)
	{
		...
		return redirect('office/admin/settings/monedas')->with('msj', $nombre.' Currency Deleted Successfully');
	}
	//fin confi monedas
}
