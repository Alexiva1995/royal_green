    ...
    public function nombre(Request $request)
    {
        ...
        $settings = Settings::first();        
          ...
          $buscar = DB::table($settings->prefijo_wp.'users')
            ...
            if($buscar == null){
        return redirect('office/admin/info/perfil')->with('msj2', 'El usuario no esta registrado');
            }
     ...
     public function usuario(Request $request)
    {
        ...
        $settings = Settings::first();
          ...
          $buscar = DB::table($settings->prefijo_wp.'users')
            ...
            if($buscar == null){
        return redirect('office/admin/info/perfil')->with('msj3', 'El id no esta registrado');
            }
...
$usuario = DB::table($settings->prefijo_wp.'users')
    ...
    public function nombrebus(Request $request)
    {
        ...
        $pago = DB::table('pagos')
            ...
            if($pago == null){
        return redirect('office/admin/info/reportes')->with('msj2', 'El usuario no esta registrado');
            }
